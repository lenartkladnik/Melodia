...
extern const unsigned int queue_items = 6;
...
extern const sf::Color dark_main_color = add_int_to_color(main_color, -5); // ({209, 204, 194});
extern const sf::Color background_color({227, 219, 211}); //({196, 186, 189});
extern const sf::Color dark_background_color = add_int_to_color(background_color, -5); // ({156, 146, 149});
extern const sf::Color light_background_color({217, 211, 200});
extern const sf::Color lighter_background_color({0, 0, 0, 5});
extern const sf::Color background_shadow_color = add_int_to_color(background_color, -20); // ({176, 166, 169});
extern const sf::Color dark_background_shadow_color = add_int_to_color(dark_background_color, -10); // ({153, 144, 147});
