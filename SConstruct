...
def ensure_deps_repo(dep_name, repo_url):
    dep_dir = f"external/{dep_name}"
...
if target in ("all", "windows"):
    ...
    deps_build_dir = "external/build-mingw-deps"

    ensure_dependency_build("ogg", "external/libogg", f"{deps_build_dir}/ogg", [
        "-DCMAKE_SYSTEM_NAME=Windows",
        "-DCMAKE_C_COMPILER=x86_64-w64-mingw32-gcc",
        "-DCMAKE_CXX_COMPILER=x86_64-w64-mingw32-g++",
    ])

    ensure_dependency_build("vorbis", "external/libvorbis", f"{deps_build_dir}/vorbis", [
        "-DCMAKE_SYSTEM_NAME=Windows",
        "-DCMAKE_C_COMPILER=x86_64-w64-mingw32-gcc",
        "-DCMAKE_CXX_COMPILER=x86_64-w64-mingw32-g++",
        "-DBUILD_TESTING=OFF",
        f"-DOGG_INCLUDE_DIR={os.path.abspath('external/libogg/include')}",
        f"-DOGG_LIBRARY={os.path.abspath(deps_build_dir)}/ogg/lib/libogg.a",
    ])

    ensure_dependency_build("flac", "external/flac", f"{deps_build_dir}/flac", [
        "-DCMAKE_SYSTEM_NAME=Windows",
        "-DCMAKE_C_COMPILER=x86_64-w64-mingw32-gcc",
        "-DCMAKE_CXX_COMPILER=x86_64-w64-mingw32-g++",
    ...
    ensure_dependency_build("openal-soft", "external/openal-soft", f"{deps_build_dir}/openal-soft", [
        "-DCMAKE_SYSTEM_NAME=Windows",
        "-DBUILD_SHARED_LIBS=FALSE",
    ...
    ensure_dependency_build("harfbuzz", "external/harfbuzz", f"{deps_build_dir}/harfbuzz", [
        "-DCMAKE_SYSTEM_NAME=Windows",
        "-DCMAKE_C_COMPILER=x86_64-w64-mingw32-gcc",
        "-DCMAKE_CXX_COMPILER=x86_64-w64-mingw32-g++",
        "-DBUILD_SHARED_LIBS=FALSE",
    ...
    ensure_dependency_build("freetype", "external/freetype", f"{deps_build_dir}/freetype", [
        "-DCMAKE_SYSTEM_NAME=Windows",
        "-DCMAKE_C_COMPILER=x86_64-w64-mingw32-gcc",
        "-DCMAKE_CXX_COMPILER=x86_64-w64-mingw32-g++",
        "-DBUILD_SHARED_LIBS=FALSE",
